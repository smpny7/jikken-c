...
char *exec_command(char cmd, char *param)
{
    ...
    case 'Q':
        is_restarting = true;
        sprintf(message, ">> Server Reaccepted Successfully.\n");
        return message;
        break;
    case 'D':
        is_stopping = true;
        sprintf(message, ">> Server Closed Successfully.\n");
        return message;
        break;
    case 'C':
...
char *parse_line(char *line)
{
    ...
    else
    {
        ...
        {
            sprintf(message, ">> Register Successfully.\n\n");
            return message;
        }
        else
        {
            sprintf(message, ">> Register Failed.\n\n");
            return message;
        }
    }
}
